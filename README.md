...
[![trunk](https://github.com/dnsco/recoil-test-render-hooks/actions/workflows/trunk.yml/badge.svg)](https://github.com/dnsco/recoil-test-render-hooks/actions/workflows/trunk.yml)
...
1. Setup a clone of this repo:
   ...
   ```
   gh repo clone dnsco/recoil-test-render-hooks <your package name> && cd <your package name> && yarn
   ```
...
```
gh repo clone dnsco/recoil-test-render-hooks foobar \
   && cd foobar \
   && yarn \
   && yarn bootstrap \
